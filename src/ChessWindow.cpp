...
void GUI::ChessWindow::createKing(const int xPos, const int yPos, bool isWhite) {
    try {
        ...
        if (isWhite) {
            buttonSquares[xPos][yPos]->setIcon(QIcon(":/images/white_king.png"));
        }
        else {
            buttonSquares[xPos][yPos]->setIcon(QIcon(":/images/black_king.png"));
        }
...
void GUI::ChessWindow::createQueen(const int xPos, const int yPos, bool isWhite) {
    ...
    if (isWhite) {
        buttonSquares[xPos][yPos]->setIcon(QIcon(":/images/white_queen.png"));
    }
    else {
        buttonSquares[xPos][yPos]->setIcon(QIcon(":/images/black_queen.png"));
    }
...
void GUI::ChessWindow::createRook(const int xPos, const int yPos, bool isWhite) {
    ...
    if (isWhite) {
        buttonSquares[xPos][yPos]->setIcon(QIcon(":/images/white_rook.png"));
    }
    else {
        buttonSquares[xPos][yPos]->setIcon(QIcon(":/images/black_rook.png"));
    }
...
void GUI::ChessWindow::createBishop(const int xPos, const int yPos, bool isWhite) {
    ...
    if (isWhite) {
        buttonSquares[xPos][yPos]->setIcon(QIcon(":/images/white_bishop.png"));
    }
    else {
        buttonSquares[xPos][yPos]->setIcon(QIcon(":/images/black_bishop.png"));
    }
...
void GUI::ChessWindow::createPawn(const int xPos, const int yPos, bool isWhite) {
    ...
    if (isWhite) {
        buttonSquares[xPos][yPos]->setIcon(QIcon(":/images/white_pawn.png"));
    }
    else {
        buttonSquares[xPos][yPos]->setIcon(QIcon(":/images/black_pawn.png"));
    }
...
void GUI::ChessWindow::createKnight(const int xPos, const int yPos, bool isWhite) {
    ...
    if (isWhite) {
        buttonSquares[xPos][yPos]->setIcon(QIcon(":/images/white_knight.png"));
    }
    else {
        buttonSquares[xPos][yPos]->setIcon(QIcon(":/images/black_knight.png"));
    }
